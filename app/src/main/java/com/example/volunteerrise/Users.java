...
public class Users {
    String profilepic, mail,userName,password,userId,lastMessage,status,dob,contact;
    ...
    public Users(String id, String name, String email, String password, String cPassword, String imageUri, String status) {
        ...
        this.status = status;
        // Optional: cPassword is not used or stored; you can remove it if not needed
    }
